package ai.accelera.library.managers

import ai.accelera.library.Accelera.IS_OPENED_FROM_PUSH_BUNDLE_KEY
import ai.accelera.library.models.DIRECT
import ai.accelera.library.models.LINK
import ai.accelera.library.models.PUSH
...
internal class LifecycleManager(
     ...
     * when Accelera.init() was called in Activity.onCreate()
     **/
    ...
    override fun onActivityStarted(activity: Activity) = LoggingExceptionHandler.runCatching {
        Timber.d("onActivityStarted. activity: ${activity.javaClass.simpleName}")
    ...
    override fun onActivityResumed(activity: Activity) {
        Timber.d("onActivityResumed. activity: ${activity.javaClass.simpleName}")
    ...
    override fun onActivityPaused(activity: Activity) {
        Timber.d("onActivityPaused. activity: ${activity.javaClass.simpleName}")
    ...
    override fun onActivityStopped(activity: Activity) {
        Timber.d("onActivityStopped. activity: ${activity.javaClass.simpleName}")
    ...
    private fun onAppMovedToBackground() = LoggingExceptionHandler.runCatching {
        Timber.d("onAppMovedToBackground")
    ...
    private fun onAppMovedToForeground() = LoggingExceptionHandler.runCatching {
        Timber.d("onAppMovedToForeground")
    ...
    private fun sendTrackVisit(
        ...
        if (areActivitiesEqual || source != DIRECT) {
            ...
            Timber.d("Track visit event with source $source and url $requestUrl")
        }
    }
